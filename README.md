...
[M8B](docs/M8B_EQUIPMENT.md) adds **two equipment identities, nine qualified historical claims, three guide sources and one receipt** for Righteous Verdict and Witch's Ring. This source checkout contains **320 entities, 1,435 claims, 85 evidence records, 27 patches, one strategy and four receipts**. Four acquisition/effect questions gain source-linked partial answers. Setup-dependent values are not intrinsic or current stats; the ring's stamina-bonus magnitude remains unresolved. The same conservative PC-Steam and claim-review limitations apply.
