...
| Dataset scope | `quality/public-release-scope.json` identifies the deliberately retained records and publication boundary. M3–M5 keep the M1 canonical bytes fixed. |
